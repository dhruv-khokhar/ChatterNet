// similar to logger.js of identity-service - just change service name in defaultMeta
...
const logger = winston.createLogger({
    ...
    defaultMeta : {service : 'api-gateway'},   // here we are just giving the metadata - what service we are using for this particular logger
